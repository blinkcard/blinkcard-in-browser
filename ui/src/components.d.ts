...
export namespace Components {
    interface BlinkcardInBrowser {
        ...
        /**
          * List of recognizers which should be used.  Available recognizers for BlinkCard:  - BlinkCardRecognizer  Recognizers can be defined by setting HTML attribute "recognizers", for example:  ``` const blinkCard = document.querySelector('blinkcard-in-browser'); blinkCard.recognizers = ['BlinkCardRecognizer']; ```
         */
        ...
        /**
          * Set to 'true' if scan from image should be enabled.  Default value is 'false'.
         */
...
declare global {
    ...
    var HTMLBlinkcardInBrowserElement: {
        prototype: HTMLBlinkcardInBrowserElement;
        new (): HTMLBlinkcardInBrowserElement;
    };
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            "blinkcard-in-browser": LocalJSX.BlinkcardInBrowser & JSXBase.HTMLAttributes<HTMLBlinkcardInBrowserElement>;
